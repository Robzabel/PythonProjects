...
def sendMail(to,  body):
    ...
    server.login('robertozabelio31@gmail.com', 'Capital123!')       # Log into the SMTP server with a valid account
    server.sendmail('robertozabelio31@gmail.com', to,body)          # Set the send from address and then input the variables for the destination and text body
